...
namespace SalePCRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, AbstractPCDbContext>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IClientService, ClientServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IHardwareService, HardwareServiceDB>(new
           HierarchicalLifetimeManager());
            container.RegisterType<IPCService, PCServiceDB>(new
           HierarchicalLifetimeManager());
